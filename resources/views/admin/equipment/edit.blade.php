...
@section('page-subtitle', 'Mengedit data alat berat')
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-warning text-dark">
                    <h5 class="card-title mb-0">
                        <i class="fas fa-edit me-2"></i>Form Edit Alat Berat
                    </h5>
                </div>
                    ...
                    <form method="POST" action="{{ route('admin.equipment.update', $equipment) }}" enctype="multipart/form-data">
                                ...
                                <select name="kategori_id" id="kategori_id" class="form-select @error('kategori_id') is-invalid @enderror" required>
                                    ...
                                    @foreach($kategoris as $kategori)
                                        <option value="{{ $kategori->id }}" 
                                                {{ (old('kategori_id') ?? $equipment->kategori_id) == $kategori->id ? 'selected' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="harga_per_hari" id="harga_per_hari" 
                                           ...
                                           value="{{ old('harga_per_hari') ?? $equipment->harga_per_hari }}" 
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="status" id="status" class="form-select @error('status') is-invalid @enderror" required>
                                    ...
                                    <option value="disewa" {{ (old('status') ?? $equipment->status) == 'disewa' ? 'selected' : '' }}>Disewa</option>
                        ...
                        <div class="mb-3">
                            ...
                            @if($equipment->foto_utama)
                                <div class="mb-2">
                                    <img src="{{ $equipment->foto_utama_url }}" alt="Foto saat ini" 
                            ...
                            <input type="file" name="foto_utama" id="foto_utama" 
                                   ...
                                   accept="image/*">
                            <div class="form-text">Upload foto baru untuk mengganti. Format JPG, PNG. Maksimal 2MB.</div>
                            @error('foto_utama')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            ...
                            <div id="preview" class="mt-2" style="display: none;">
                                ...
                                <small class="d-block text-muted">Preview foto baru</small>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="spesifikasi" id="spesifikasi" rows="4" 
                                      ...
                                      placeholder="Deskripsi spesifikasi teknis alat...">{{ old('spesifikasi') ?? $equipment->spesifikasi }}</textarea>
                            @error('spesifikasi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="deskripsi" id="deskripsi" rows="3" 
                                      ...
                                      placeholder="Deskripsi singkat tentang alat...">{{ old('deskripsi') ?? $equipment->deskripsi }}</textarea>
                            @error('deskripsi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('admin.equipment.show', $equipment) }}" class="btn btn-info">
